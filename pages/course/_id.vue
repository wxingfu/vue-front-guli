  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="/course" title class="c-999 fsize14">全部课程</a>
        \
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section id="videoPlay" class="p-h-video-box">
            <img style="width: 100%;height: 100%" :src="course.cover" :alt="course.title" class="dis c-v-pic">
          </section>
        </article>
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt">
              <a v-if="isBuyCourse || Number(course.price)===0"
                 href="#" title="立即观看"
      ...
      <div class="mt20 c-infor-box">
        <article class="fl col-7">
          <section class="mr30">
            ...
            <div class="i-box" style="margin-top: 24px">
              <!--课程评论 开始-->
                ...
                <div>
                  ...
                  <section class="lh-bj-list pr mt20 replyhtml">
                    <ul>
                      ...
                      <textarea name="" v-model="comment.content" placeholder="输入您要评论的文字"
                                id="commentContent" style="width: 750px;height: 85px"></textarea>
                            </fieldset>
                  ...
                  <div class="paging">
                    ...
                    <a
                      ...
                      href="#"
                      title="首页"
                      @click.prevent="gotoPageComment(1)">首</a>
                    <a
                      :class="{undisable: !data.hasPrevious}"
                      href="#"
                      title="前一页"
                      @click.prevent="gotoPageComment(data.current-1)">&lt;</a>
                    <a
                      ...
                      :title="'第'+page+'页'"
                      href="#"
                      @click.prevent="gotoPageComment(page)">{{ page }}</a>
                    <a
                    ...
                    <a
                      ...
                      href="#"
                      title="末页"
                      @click.prevent="gotoPageComment(data.pages)">末</a>
                    <div class="clear"/>
                  </div>
                  <!-- 公共分页 结束 -->
                </div>
...
export default {
  ...
  // asyncData({params, error}) {
  //   return course.getCourseByCourseId(params.id).then(response => {
  ...
  methods: {
    ...
    initCourseInfo() {
      course.getCourseByCourseId(this.courseId)
        .then(response => {
          // 课程信息
    ...
    initComment() {
      comment.getPageCommentList(this.page, this.limit, this.courseId).then(response => {
    ...
    gotoPageComment(page) {
      comment.getPageCommentList(page, this.limit, this.courseId).then(response => {
        this.data = response.data.data
      })
    }
  }
