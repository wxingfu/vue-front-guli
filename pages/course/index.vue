        ...
        <div>
          <div class="paging">
            ...
            <a
              ...
              href="#"
              title="首页"
              @click.prevent="gotoPageCourse(1)">首</a>
            <a
              :class="{undisable: !data.hasPrevious}"
              href="#"
              title="前一页"
              @click.prevent="gotoPageCourse(data.current-1)">&lt;</a>
            <a
              ...
              :title="'第'+page+'页'"
              href="#"
              @click.prevent="gotoPageCourse(page)">{{ page }}</a>
            <a
            ...
            <a
              ...
              href="#"
              title="末页"
              @click.prevent="gotoPageCourse(data.pages)">末</a>
            <div class="clear"/>
          </div>
        </div>
        <!-- 公共分页 结束 -->
...
export default {
  ...
  data() {
    return {
      ...
      searchObj: {}, // 查询表单对象
      oneIndex: -1,// 用于一级分类选中样式调整
      twoIndex: -1,// 用于二级分类选中样式调整
      buyCountSort: "",// 用于销量排序选中样式调整
      gmtCreateSort: "",// 用于最新时间排序选中样式调整
      priceSort: ""// 用于价格排序选中样式调整
    }
  },
  ...
  methods: {
    ...
    initSubject() {
      //debugger
      course.getCourseNestedTreeList2().then(response => {
